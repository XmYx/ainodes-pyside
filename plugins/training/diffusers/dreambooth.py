...
from huggingface_hub import HfFolder, Repository, whoami, create_repo, upload_folder
...
def run_diff_dreambooth(
        ...
        instance_data_dir='/data/input',        # A folder containing the training data of instance images.
        ...
        num_class_images=100,                   # Minimal class images for prior preservation loss. If there are not enough images already present in
                                                # class_data_dir, additional images will be sampled with class_prompt.
        ...
        center_crop=False,                      # Whether to center crop images before resizing to resolution
        ...
        num_train_epochs=1,                     # how many epochs are to be trained
        max_train_steps=None,                   # Total number of training steps to perform. If provided, overrides num_train_epochs.
        checkpointing_steps=500,                # Save a checkpoint of the training state every X updates. These checkpoints can be used both as final
                                                # checkpoints in case they are better than the last checkpoint, and are also suitable for resuming
                                                # training using `--resume_from_checkpoint`.
        ...
        lr_scheduler="constant",                # The scheduler type to use. Choose between ["linear", "cosine", "cosine_with_restarts", "polynomial",
                                                # "constant", "constant_with_warmup"]
        lr_warmup_steps=1,                      # Number of steps for the warmup in the lr scheduler.
        ...
        adam_weight_decay=1e-2,                 # Weight decay to use.
        ...
        logging_dir='data/logs',                # [TensorBoard](https://www.tensorflow.org/tensorboard) log directory. Will default to
                                                # *output_dir/runs/**CURRENT_DATETIME_HOSTNAME***.
        allow_tf32=False,                       # Whether or not to allow TF32 on Ampere GPUs. Can be used to speed up training. For more information, see
                                                # https://pytorch.org/docs/stable/notes/cuda.html#tensorfloat-32-tf32-on-ampere-devices
