...
from plugins.dreambooth.dreambooth_class import DreamBooth

class FineTune(QObject):

    def __init__(self, *args, **kwargs):
        loader = QtUiTools.QUiLoader()
        file = QFile("plugins/dreambooth/finetune.ui")
...
class aiNodesPlugin:
    ...
    def initme(self):
        print("Dreambooth")
        gs.system.dreambooth_config = "plugins/dreambooth/configs"
