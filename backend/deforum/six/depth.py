...
class DepthModel():
    ...
    def load_adabins(self,models_path, target):
        ...
        gs.models["adabins"] = InferenceHelper(dataset='nyu', device=target)
    ...
    def predict(self, prev_img_cv2, anim_args) -> torch.Tensor:
        ...
        use_adabins = anim_args.midas_weight < 1.0 and gs.models["adabins"] is not None
        if use_adabins:
