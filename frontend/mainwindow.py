...
class MainWindow(QMainWindow):
    ...
    def create_sys_folders(self):
        ...
        os.makedirs(gs.system.img2img_single_frame_dir, exist_ok=True)
        os.makedirs(gs.system.txt2vid_out_dir, exist_ok=True)
        os.makedirs(gs.system.txt2vid_tmp_dir, exist_ok=True)
    ...
    def path_setup_temp(self):
        ...
        self.path_setup.w.img2img_single_frame_dir.setText(gs.system.img2img_single_frame_dir)
        self.path_setup.w.txt2vid_out_dir.setText(gs.system.txt2vid_out_dir)
        self.path_setup.w.txt2vid_tmp_dir.setText(gs.system.txt2vid_tmp_dir)
