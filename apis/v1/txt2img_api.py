...
async def post(t2i_json: Txt2Img, background_tasks: BackgroundTasks):
    try:
        ...
        image_bytes = txt2img_json(t2i_json) # txt2img_json has to return the image as byte array
        return Response(content=image_bytes, media_type="image/png")# this will return the image to the UI
                                                                    # it should be the same as getting an image from lexica
        # if image has to come from filesystem this will work
