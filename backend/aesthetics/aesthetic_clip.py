...
class AestheticCLIP:
    ...
    def __call__(self, remade_batch_tokens, multipliers):
        ...
        if not self.skip and self.aesthetic_steps != 0 and self.aesthetic_lr != 0 and self.aesthetic_weight != 0 and gs.aesthetic_embedding_path != os.path.join(gs.system.aesthetic_gradients_dir, 'None'):
