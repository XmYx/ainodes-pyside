...
class aiNodesPlugin:
    ...
    def run_preprocess(self, progress_callback=False):
        ...
        preprocess(
            ...
            process_caption_deepbooru=False, #self.training.w.process_caption_deepbooru.isChecked(),
            split_threshold=self.training.w.split_threshold.value(),
            overlap_ratio=self.training.w.overlap_ratio.value(),
            process_focal_crop=self.training.w.toggle_focal_crop.isChecked(),
            process_focal_crop_face_weight=self.training.w.process_focal_crop_face_weight.value(),
            process_focal_crop_entropy_weight=self.training.w.process_focal_crop_entropy_weight.value(),
            process_focal_crop_edges_weight=self.training.w.process_focal_crop_edges_weight.value(),
