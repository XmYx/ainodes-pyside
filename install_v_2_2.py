...
def start_sdui():
    ...
    import frontend_v2_2.startup
    frontend_v2_2.startup.run_app()
...
if __name__ == "__main__":
    if check_run_setup():
        print('running setup as run_setup is true, change in settings if you dont like to wait for this')
        prepare_enviroment()
