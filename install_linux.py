...
def prepare_enviroment():
    ...
    deepdanbooru_package = os.environ.get('DEEPDANBOORU_PACKAGE',
    ...
    taming_transformers_repo = os.environ.get('TAMING_REANSFORMERS_REPO',
    ...
    impro_aesthetic_repo = os.environ.get('IMPRO_AESTHETIC_REPO',
                                          'https://github.com/christophschuhmann/improved-aesthetic-predictor.git')
    ...
    if not is_installed("deepdanbooru") and deepdanbooru:
        run_pip(f"install {deepdanbooru_package}#egg=deepdanbooru[tensorflow] tensorflow==2.10.0 tensorflow-io==0.27.0",
                "deepdanbooru")
    ...
    git_clone(impro_aesthetic_repo, repo_dir('improved-aesthetic-predictor'), "improved-aesthetic-predictor",
              impro_aesthetic_hash)
...
def start_sdui():
    ...
    print(colored("You might see a few warnings about No instance of QPyDesignerCustomWidgetCollection was found.",
                  "green"))
