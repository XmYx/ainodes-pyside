...
class DreamBooth:
    ...
    def dreambooth(self,
                   name='some_job',
                   resume='',
                   base=['configs/dreambooth/v1-finetune_unfrozen.yaml'],
                   train=True,
                   no_test=False,
                   project=None,
                   debug=False,
                   ...
                   actual_resume='models/custom/wd-v1-3-float16.ckpt',
                   data_root='input/images',
                   reg_data_root='input/regularization/images',
    ...
    def run_dreambooth(self, opt):
        ...
        try:
            ...
            default_callbacks_cfg = {
                "setup_callback": {
                    "target": "backend.d_b.callbacks.SetupCallback",
                    "params": {
                        "resume": opt.resume,
                        "now": now,
                        "logdir": logdir,
                ...
                "image_logger": {
                    "target": "backend.d_b.callbacks.ImageLogger",
                    "params": {
                        "batch_frequency": 750,
                        "max_images": 4,
                        "clamp": True
                ...
                "learning_rate_logger": {
                    "target": "backend.d_b.callbacks.LearningRateMonitor",
                    "params": {
                ...
                "cuda_callback": {
                    "target": "backend.d_b.callbacks.CUDACallback"
                },
            }
            if version.parse(pl.__version__) >= version.parse('1.4.0'):
